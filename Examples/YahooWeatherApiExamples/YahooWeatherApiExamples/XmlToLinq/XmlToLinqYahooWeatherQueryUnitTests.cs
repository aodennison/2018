...
{
    [TestFixture]
    public class XmlToLinqYahooWeatherQueryUnitTests
    {
        [Test]
...
";
            ...
            string actual = new XmlToLinqYahooWeatherQuery().DeserializeAndFormat(Xml1Location);
...
";
            ...
            string actual = new XmlToLinqYahooWeatherQuery().DeserializeAndFormat(Xml2Locations);
